<?php
	...
	<div class="wrap about__container">
		...
		<div class="about__header">
			<div class="about__header-title">
				<h1>
					<?php
 printf( __( 'WordPress %s' ), $display_version ); ?>
				</h1>
			</div>
		</div>
 ...
 printf( __( 'Welcome to WordPress %s' ), $display_version ); ?>
		...
		<div class="about__section has-2-columns">
			...
			<div class="column">
				...
				<p>
					<?php
 printf( __( 'There&#8217;s now an easier way to manage plugin dependencies. Plugin authors can supply a new %s header with a comma-separated list of required plugin slugs, presenting users with links to install and activate those plugins first.' ), '<code lang="en">Requires Plugins</code>' ); ?>
				</p>
			</div>
		</div>
 ...
 printf( __( 'Learn more about WordPress %s' ), $display_version ); ?>
				...
				<p>
					<?php
 printf( __( '<a href="%1$s">Learn WordPress</a> is a free resource for new and experienced WordPress users. Learn is stocked with how-to videos on using various features in WordPress, <a href="%2$s">interactive workshops</a> for exploring topics in-depth, and lesson plans for diving deep into specific areas of WordPress.' ), 'https://learn.wordpress.org/', 'https://learn.wordpress.org/online-workshops/' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
 printf( __( 'Explore the <a href="%1$s">WordPress %2$s Field Guide</a>. Learn about the changes in this release with detailed developer notes to help you build with WordPress.' ), esc_url( __( 'https://make.wordpress.org/core/wordpress-6-5-field-guide/' ) ), '6.5' ); ?>
				</p>
			</div>
			<div class="column">
				<div class="about__image">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
 printf( __( '<a href="%1$s">Read the WordPress %2$s Release Notes</a> for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ), sprintf( esc_url( __( 'https://wordpress.org/documentation/wordpress-version/version-%s/' ) ), '6-5' ), '6.5' ); ?>
				</p>
			</div>
		</div>
		...
		<div class="return-to-dashboard">
			<?php
 if ( isset( $_GET['updated'] ) && current_user_can( 'update_core' ) ) { printf( '<a href="%1$s">%2$s</a> | ', esc_url( self_admin_url( 'update-core.php' ) ), is_multisite() ? __( 'Go to Updates' ) : __( 'Go to Dashboard &rarr; Updates' ) ); } printf( '<a href="%1$s">%2$s</a>', esc_url( self_admin_url() ), is_blog_admin() ? __( 'Go to Dashboard &rarr; Home' ) : __( 'Go to Dashboard' ) ); ?>
		</div>
	</div>
