...
<?php endif; ?>
		<tr class="form-field term-description-wrap">
			...
			<td><textarea name="description" id="description" rows="5" cols="50" class="large-text" aria-describedby="description-description"><?php echo $tag->description; ?></textarea>
