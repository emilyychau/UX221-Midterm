...
<h2 class="title"><?php _e( 'Update Services' ); ?></h2>
	...
	<p><label for="ping_sites">
		<?php
 printf( __( 'When you publish a new post, WordPress automatically notifies the following site update services. For more about this, see the <a href="%s">Update Services</a> documentation article. Separate multiple service URLs with line breaks.' ), __( 'https://wordpress.org/documentation/article/update-services/' ) ); ?>
	</label></p>
	...
	<p>
		<?php
 printf( __( 'WordPress is not notifying any <a href="%1$s">Update Services</a> because of your site&#8217;s <a href="%2$s">visibility settings</a>.' ), __( 'https://wordpress.org/documentation/article/update-services/' ), 'options-reading.php' ); ?>
	</p>
