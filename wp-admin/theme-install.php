...
<div class="wrap">
 ...
 $tabs = apply_filters( 'install_themes_tabs', array( 'upload' => __( 'Upload Theme' ) ) ); if ( ! empty( $tabs['upload'] ) && current_user_can( 'upload_themes' ) ) { echo ' <button type="button" class="upload-view-toggle page-title-action hide-if-no-js" aria-expanded="false">' . __( 'Upload Theme' ) . '</button>'; } ?>
	...
	<?php
 wp_admin_notice( __( 'The Theme Installer screen requires JavaScript.' ), array( 'additional_classes' => array( 'error', 'hide-if-js' ), ) ); ?>
...
<script id="tmpl-theme" type="text/template">
	...
	<# if ( data.installed ) { #>
		<?php
 wp_admin_notice( _x( 'Installed', 'theme' ), array( 'type' => 'success', 'additional_classes' => array( 'notice-alt' ), ) ); ?>
	<# } #>
