...
<table class="form-table" role="presentation">
 ...
 do_action( 'user_new_form', 'add-existing-user' ); ?>
	...
	<?php
} if ( current_user_can( 'create_users' ) ) { if ( $do_both ) { echo '<h2 id="create-new-user">' . __( 'Add New User' ) . '</h2>'; } ?>
...
<table class="form-table" role="presentation">
	...
	<tr class="form-field">
		...
		<?php
 $languages = get_available_languages(); if ( $languages ) : ?>
		<tr class="form-field user-language-wrap">
			...
			<td>
				<?php
 wp_dropdown_languages( array( 'name' => 'locale', 'id' => 'locale', 'selected' => 'site-default', 'languages' => $languages, 'show_available_translations' => false, 'show_option_site_default' => true, ) ); ?>
			</td>
		</tr>
		<?php endif; ?>
	...
	<tr class="form-field">
		...
		<td><select name="role" id="role">
			<?php
 if ( ! $new_user_role ) { $new_user_role = get_option( 'default_role' ); } wp_dropdown_roles( $new_user_role ); ?>
			</select>
		</td>
	</tr>
	<?php } ?>
