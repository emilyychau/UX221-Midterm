<?php
 class WP_Customize_Nav_Menu_Control extends WP_Customize_Control { public $type = 'nav_menu'; public function render_content() {} public function content_template() { $add_items = __( 'Add Items' ); ?>
		<p class="new-menu-item-invitation">
			<?php
 printf( __( 'Time to add some links! Click &#8220;%s&#8221; to start putting pages, categories, and custom links in your menu. Add as many things as you would like.' ), $add_items ); ?>
		</p>
